		...
		local retrieveCor = coroutine.wrap( function()
			for _, textscreen in ipairs( textscreens ) do
				...
				for i = 1, #entries do
					...
					net.WriteColor( ToColor( entries[i].effectData.color ) )
					net.WriteFloat( entries[i].effectData.stroke )
					net.WriteColor( ToColor( entries[i].effectData.strokeColor ) )
					net.WriteFloat( entries[i].effectData.shadowBlur )
					net.WriteColor( ToColor( entries[i].effectData.shadowColor ) )
